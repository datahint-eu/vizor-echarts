...
public partial class YData
{
    /// <summary>
    /// Since v6.0.0   
    /// The text in the header cell.
    /// Can also be used as a index of this column or row.
    /// Optional.
    /// If not specified, auto generate a text.
    /// </summary>
    ...
    //TODO: Type Warning: array type 'children' in 'yData' will be mapped to List<object>
