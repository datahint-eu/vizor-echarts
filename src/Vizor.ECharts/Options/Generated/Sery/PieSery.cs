...
public partial class PieSery
{
    ...
    [DefaultValue(false)]
    //TODO: Type Warning: Failed to map property 'roseType' in type 'PieSery' with types 'boolean,enum'
    ...
    [DefaultValue("true")]
    //TODO: Type Warning: Failed to map property 'emptyCircleStyle' in type 'PieSery' with types 'boolean,object'
    ...
    //TODO: Type Warning: array type 'dimensions' in 'PieSery' will be mapped to List<object>
    ...
    public List<PieSeryData>? Data { get; set; } 
