...
public partial class BoxplotSery
{
    /// <summary>
    /// 
    /// </summary>
    ...
    [DefaultValue("7,50")]
    public NumberOrNumberArray? BoxWidth { get; set; } 
    ...
    //TODO: Type Warning: array type 'dimensions' in 'BoxplotSery' will be mapped to List<object>
    ...
    public List<BoxplotSeryData>? Data { get; set; } 
