...
public partial class EffectScatterSery
{
    /// <summary>
    /// 
    /// </summary>
    ...
    [DefaultValue("ripple")]
    //TODO: Type Warning: enum type 'effectType' in 'EffectScatterSery' with values 'ripple' is not mapped
    ...
    //TODO: Type Warning: array type 'dimensions' in 'EffectScatterSery' will be mapped to List<object>
    ...
    public List<EffectScatterSeryData>? Data { get; set; } 
