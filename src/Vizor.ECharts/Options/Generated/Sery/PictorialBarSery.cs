...
public partial class PictorialBarSery
{
    /// <summary>
    /// 
    /// </summary>
    ...
    ///  
    /// In a single coordinate system, this attribute is shared by multiple 'pictorialBar' series.
    /// This attribute should be set on the last 'pictorialBar' series in the coordinate system, then it will be adopted by all 'pictorialBar' series in the coordinate system.
    /// ]]>
    /// </summary>
    ...
    [DefaultValue("start")]
    //TODO: Type Warning: enum type 'symbolPosition' in 'PictorialBarSery' with values 'start,end,center' is not mapped
    ...
    //TODO: Type Warning: Failed to map property 'symbolRepeat' in type 'PictorialBarSery' with types 'boolean,enum,number'
    ...
    [DefaultValue("start")]
    //TODO: Type Warning: enum type 'symbolRepeatDirection' in 'PictorialBarSery' with values 'start,end' is not mapped
    ...
    [DefaultValue("0,0")]
    //TODO: Type Warning: Failed to map property 'symbolMargin' in type 'PictorialBarSery' with types 'number,percentvector,string'
    ...
    /// <summary>
    /// <![CDATA[
    /// Defines a bounding area available for the graphic elements.
    ...
    /// The size of the graphic element is determined by symbolBoundingData .
    ...
    //TODO: Type Warning: array type 'dimensions' in 'PictorialBarSery' will be mapped to List<object>
    ...
    public List<PictorialBarSeryData>? Data { get; set; } 
