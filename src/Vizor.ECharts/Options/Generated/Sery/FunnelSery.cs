...
public partial class FunnelSery
{
    /// <summary>
    /// 
    /// </summary>
    ...
    //TODO: Type Warning: enum,function type 'sort' in 'FunnelSery' could not resolve enum type
    ...
    [DefaultValue("center")]
    //TODO: Type Warning: enum type 'funnelAlign' in 'FunnelSery' with values 'left,center,right' is not mapped
    ...
    //TODO: Type Warning: array type 'dimensions' in 'FunnelSery' will be mapped to List<object>
    ...
    public List<FunnelSeryData>? Data { get; set; } 
