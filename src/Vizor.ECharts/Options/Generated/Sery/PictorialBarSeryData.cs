...
public partial class PictorialBarSeryData
{
    /// <summary>
    ...
    [DefaultValue("start")]
    //TODO: Type Warning: enum type 'symbolPosition' in 'PictorialBarSeryData' with values 'start,end,center' is not mapped
    ...
    //TODO: Type Warning: Failed to map property 'symbolRepeat' in type 'PictorialBarSeryData' with types 'boolean,enum,number'
    ...
    [DefaultValue("start")]
    //TODO: Type Warning: enum type 'symbolRepeatDirection' in 'PictorialBarSeryData' with values 'start,end' is not mapped
    ...
    [DefaultValue("0,0")]
    //TODO: Type Warning: Failed to map property 'symbolMargin' in type 'PictorialBarSeryData' with types 'number,percentvector,string'
