...
public partial class X
{
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specifies the data for the x-axis cells.
    ...
    ///     ]
    /// }]  
    /// If matrix.x.data is not provided, it will be collected from series.data or dataset.soruce .
    ///  
    ...
    public List<XData>? Data { get; set; } 

    /// <summary>
    /// Since v6.0.0   
    /// Text label of x-axis cells, to explain some data information about graphic item like value, name and so on.
    ...
    public List<XLevel>? Levels { get; set; } 
