...
public partial class SliderDataZoom
{
    /// <summary>
    ...
    [DefaultValue("auto")]
    public BoolOrString? ShowDataShadow { get; set; } 
    ...
    public DateOrNumberOrString? StartValue { get; set; } 
    ...
    public DateOrNumberOrString? EndValue { get; set; } 
    ...
    public DateOrNumberOrString? MinValueSpan { get; set; } 
    ...
    public DateOrNumberOrString? MaxValueSpan { get; set; } 
    ...
    /// See also dataZoom-slider.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this dataZoom-slider based on the specified coordinateSystem .
    ///  
    /// In most cases, there is no need to specify coordinateSystemUsage , unless the default behavior is unexpected.
    ///  
    /// Options:   
    /// 'data' : (Not applicable in dataZoom-slider )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified dataZoom-slider.coords in that system.
    ...
    ///     
    /// See also dataZoom-slider.coordinateSystem .
    /// ]]>
    /// </summary>
