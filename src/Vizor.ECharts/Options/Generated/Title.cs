...
public partial class Title
{
    ...
    ///   [WARNING]: When enabling toolbox.feature.saveAsImage , and toolbox.feature.saveAsImage.name is not provided, it has historically been using title[0].text instead.
    /// This usage is not recommended -- toolbox.feature.saveAsImage.name should always be specified explicitly; otherwise, correctness and security risks for a filename have to be considered in this title.text option.
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified title.coords in that system.
