...
public partial class XAxis
{
    ...
    /// Stacked bar or line series with type: 'log' axes may lead to significant visual errors and may have unintended effects in certain circumstances.
    ...
    ///  
    /// This is unavailable for 'category' and 'time' axes.
    ...
    public List<XAxisBreak>? Breaks { get; set; } 

    /// <summary>
    /// Since v6.0.0   
    /// Style of the axis break area.
    ///  
    /// See also the introduction to the axis break in xAxis.breaks .
    /// </summary>
    ...
    public DataList<AxisData>? Data { get; set; } 
