...
public partial class DividerLineStyle
{
    /// <summary>
    ...
    [DefaultValue("solid")]
    //TODO: Type Warning: Failed to map property 'type' in type 'dividerLineStyle' with types 'array,enum,number'
    ...
    [DefaultValue("butt")]
    //TODO: Type Warning: enum type 'cap' in 'dividerLineStyle' with values 'butt,round,square' is not mapped
    ...
    [DefaultValue("bevel")]
    //TODO: Type Warning: enum type 'join' in 'dividerLineStyle' with values 'bevel,round,miter' is not mapped
