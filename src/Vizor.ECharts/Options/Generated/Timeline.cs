...
public partial class Timeline
{
    ...
    public StringArray? ReplaceMerge { get; set; } 
    ...
    /// See also timeline.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this timeline based on the specified coordinateSystem .
    ///  
    /// In most cases, there is no need to specify coordinateSystemUsage , unless the default behavior is unexpected.
    ///  
    /// Options:   
    /// 'data' : (Not applicable in timeline )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified timeline.coords in that system.
    ...
    ///     
    /// See also timeline.coordinateSystem .
    /// ]]>
    /// </summary>
