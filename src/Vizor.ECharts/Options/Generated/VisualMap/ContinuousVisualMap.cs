...
public partial class ContinuousVisualMap : IVisualMap
{
    ...
    ///  
    /// Notice : see unboundedRange for the special case when range[0] or range[1] touch min or max .
    ...
    ///  
    /// NOTE:   This provides a way to ensure all data can be considered in-range when min / max are not precisely known.
    ...
    /// ]]>
    /// </summary>
    [JsonPropertyName("unboundedRange")]
    [DefaultValue(true)]
    ...
    ///  
    /// Options:   A index number  An array of index numbers  'all' / null / undefined (default): means all of the series.
    /// ]]>
    /// </summary>
    [JsonPropertyName("seriesIndex")]
    public NumberOrStringArray? SeriesIndex { get; set; } 
    ...
    public NumberOrStringArray? SeriesId { get; set; } 
    ...
    /// User can interact with visualMap component and make a selected range by mouse or touch.
    ...
    /// We intend to map them to an opacity range [0.4, 1] , by which the size of value can be demonstrated by the transparency of graphical elements.
    ...
    /// If you don't want it, set inRange: {color: null} to disable it.
    /// ]]>
    /// </summary>
    ...
    /// See also visualMap-continuous.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this visualMap-continuous based on the specified coordinateSystem .
    ///  
    /// In most cases, there is no need to specify coordinateSystemUsage , unless the default behavior is unexpected.
    ///  
    /// Options:   
    /// 'data' : (Not applicable in visualMap-continuous )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified visualMap-continuous.coords in that system.
    ...
    ///     
    /// See also visualMap-continuous.coordinateSystem .
    /// ]]>
    /// </summary>
