...
public partial class PiecewiseVisualMap : IVisualMap
{
    ...
    /// See also visualMap-piecewise.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this visualMap-piecewise based on the specified coordinateSystem .
    ///  
    /// In most cases, there is no need to specify coordinateSystemUsage , unless the default behavior is unexpected.
    ///  
    /// Options:   
    /// 'data' : (Not applicable in visualMap-piecewise )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified visualMap-piecewise.coords in that system.
    ...
    ///     
    /// See also visualMap-piecewise.coordinateSystem .
    /// ]]>
    /// </summary>
