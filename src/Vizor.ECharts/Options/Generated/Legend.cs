...
public partial class Legend
{
    ...
    /// See also legend.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified legend.coords in that system.
    ...
    ///     
    /// See also legend.coordinateSystem .
    /// ]]>
    /// </summary>
    ...
    [DefaultValue("auto")]
    public NumberOrString? InactiveBorderWidth { get; set; } 
    ...
    public DataList<LegendData>? Data { get; set; } 
    ...
    [DefaultValue("15,15")]
    public NumberOrNumberArray? PageIconSize { get; set; } 
