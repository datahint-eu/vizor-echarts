...
public partial class CustomSeries : ISeries
{
    ...
    /// See also series-custom.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this series-custom based on the specified coordinateSystem .
    ///  
    ...
    ///   
    /// 'box' : (Not applicable in series-custom )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified series-custom.coords in that system.
    ...
    ///  
    /// See also series-custom.coordinateSystem .
    /// ]]>
    /// </summary>
    ...
    /// <summary>
    /// <![CDATA[
    /// custom series requires developers to write a rendering logic by themselves in the form of Function , or use a registered rendering logic in the form of string (since v6.0.0 ; See echarts.registerCustomSeries for more information).
    ...
    public StringOrFunction? RenderItem { get; set; } 
