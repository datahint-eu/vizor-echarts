...
public partial class EffectScatterSeries : ISeries
{
    ...
    /// See also series-effectScatter.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this series-effectScatter based on the specified coordinateSystem .
    ///  
    ...
    ///   
    /// 'box' : (Not applicable in series-effectScatter )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified series-effectScatter.coords in that system.
    ...
    ///  
    /// See also series-effectScatter.coordinateSystem .
    /// ]]>
    /// </summary>
