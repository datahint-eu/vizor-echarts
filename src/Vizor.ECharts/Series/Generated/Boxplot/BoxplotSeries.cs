...
public partial class BoxplotSeries : ISeries
{
    ...
    /// See also series-boxplot.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this series-boxplot based on the specified coordinateSystem .
    ///  
    ...
    ///   
    /// 'box' : (Not applicable in series-boxplot )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified series-boxplot.coords in that system.
    ...
    ///  
    /// See also series-boxplot.coordinateSystem .
    /// ]]>
    /// </summary>
    ...
    [DefaultValue("7,50")]
    public NumberOrStringArray? BoxWidth { get; set; } 
