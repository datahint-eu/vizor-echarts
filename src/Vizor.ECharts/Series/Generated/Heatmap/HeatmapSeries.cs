...
public partial class HeatmapSeries : ISeries
{
    ...
    /// See also series-heatmap.coordinateSystemUsage .
    /// ]]>
    /// </summary>
    ...
    /// <![CDATA[
    /// Since v6.0.0   
    /// Specify how to lay out this series-heatmap based on the specified coordinateSystem .
    ///  
    ...
    ///   
    /// 'box' : (Not applicable in series-heatmap )  
    ...
    ///   For example, a grid component can be laid out in a matrix coordinate system or a calendar coordinate system , where its layout rectangle is calculated by the specified series-heatmap.coords in that system.
    ...
    ///  
    /// See also series-heatmap.coordinateSystem .
    /// ]]>
    /// </summary>
